/**
 * Editorial Frame + Rail — the outer chrome every screen sits inside.
 *
 * `Frame` owns the top spacer, optional rail, body, optional sticky
 * footer, and bottom spacer. `Rail` is the wordmark + eyebrow header
 * that runs across the top on every non-boot screen.
 *
 * CSS classes are defined in `src/styles.css` (`.editorial-frame`,
 * `.rail`, …).
 */
